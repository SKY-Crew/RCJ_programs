...
#endif
// double SLOPE_DIR[5][2] = {{1, 1}, {0.1, 1.8}, {0.056, 0}, {0.167, 0.278}, {0, 0}};
// double INTERCEPT_DIR[5][2] = {{0, 0}, {9, -16}, {11.667, 65}, {-5, 40}, {25, 90}};
// double POINT_DIR[4][2] = {{10, 20}, {61, 45}, {150, 90}, {180, 180}};
// double SLOPE_DIR[5][2] = {{1, 1}, {0.2, 2}, {0, 0}, {0.167, 0.222}, {0, 0}};
// double INTERCEPT_DIR[5][2] = {{0, 0}, {8, -20}, {20, 70}, {-5, 50}, {25, 90}};
